...
export const projectStructureResource: Resource = {
  ...
  async load() {
    ...
    try {
      ...
      logError(`Error fetching project structure: ${(error as Error).message}`);
      throw error;
    }
  },
};
...
export const projectSettingsResource: Resource = {
  ...
  async load() {
    ...
    try {
      ...
      logError(`Error fetching project settings: ${(error as Error).message}`);
      throw error;
    }
  },
};
...
export const projectResourcesResource: Resource = {
  ...
  async load() {
    ...
    try {
      ...
      logError(`Error fetching project resources: ${(error as Error).message}`);
      throw error;
    }
  },
};